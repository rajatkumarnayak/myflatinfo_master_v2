...
class SellRentClassifieds extends Component {
  constructor(props) {
    super();
    this.state = {
      modalVisible: false,
    ...
    return (
      ...
      <ScrollView>
        <View>
          ...
          {/* <View style={{alignSelf:'center',marginTop:10}}>
          <Button large shadowless round outline color='info' onPress={()=> this.openProductPopup()}>Products & Services </Button>
...
export default SellRentClassifieds;
